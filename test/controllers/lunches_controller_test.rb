...
class LunchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post lunches_url, params: { lunch: { name: @lunch.name, price: @lunch.price, restorent_id: @lunch.restorent_id } }
    end
  ...
  test "should update lunch" do
    patch lunch_url(@lunch), params: { lunch: { name: @lunch.name, price: @lunch.price, restorent_id: @lunch.restorent_id } }
